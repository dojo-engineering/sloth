						...
						SLORules: prometheus.SLORules{
							SLIErrorRecRules: []rulefmt.Rule{
								...
								},
								{
									...
									Expr:   "sum(sum_over_time(slo:sli_error:ratio_rate5m{sloth_id=\"test-id\", sloth_service=\"test-svc\", sloth_slo=\"test-name\"}[30d]))\n/ ignoring (sloth_window)\nsum(count_over_time(slo:sli_error:ratio_rate5m{sloth_id=\"test-id\", sloth_service=\"test-svc\", sloth_slo=\"test-name\"}[30d]))\n",
									Labels: map[string]string{
										"sloth_window": "30d",
									},
								},
