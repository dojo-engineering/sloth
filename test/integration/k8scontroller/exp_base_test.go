			...
			Groups: []monitoringv1.RuleGroup{
				{
					...
					Rules: []monitoringv1.Rule{
						...
						},
						{
							...
							Expr:   intstr.FromString("sum(sum_over_time(slo:sli_error:ratio_rate5m{sloth_id=\"svc01-slo01\", sloth_service=\"svc01\", sloth_slo=\"slo01\"}[30d]))\n/ ignoring (sloth_window)\nsum(count_over_time(slo:sli_error:ratio_rate5m{sloth_id=\"svc01-slo01\", sloth_service=\"svc01\", sloth_slo=\"slo01\"}[30d]))\n"),
							Labels: map[string]string{
								"sloth_window": "30d",
							},
						},
				...
				},
				{
					...
					Rules: []monitoringv1.Rule{
						...
						{
							Record: "slo:sli_error:ratio_rate30d",
							Expr:   intstr.FromString("sum(sum_over_time(slo:sli_error:ratio_rate5m{sloth_id=\"svc01-slo02\", sloth_service=\"svc01\", sloth_slo=\"slo02\"}[30d]))\n/ ignoring (sloth_window)\nsum(count_over_time(slo:sli_error:ratio_rate5m{sloth_id=\"svc01-slo02\", sloth_service=\"svc01\", sloth_slo=\"slo02\"}[30d]))\n"),
							Labels: map[string]string{
								"sloth_window": "30d",
							},
						},
