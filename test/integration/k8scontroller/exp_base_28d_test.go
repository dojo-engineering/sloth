...
func getBase28DayPromOpPrometheusRule(slothVersion string) *monitoringv1.PrometheusRule {
			...
			Groups: []monitoringv1.RuleGroup{
				{
					...
					Rules: []monitoringv1.Rule{
						...
						},
						{
							...
							Expr:   intstr.FromString("sum(sum_over_time(slo:sli_error:ratio_rate5m{sloth_id=\"svc01-slo01\", sloth_service=\"svc01\", sloth_slo=\"slo01\"}[4w]))\n/ ignoring (sloth_window)\nsum(count_over_time(slo:sli_error:ratio_rate5m{sloth_id=\"svc01-slo01\", sloth_service=\"svc01\", sloth_slo=\"slo01\"}[4w]))\n"),
							Labels: map[string]string{
								"sloth_window": "4w",
							},
						},
				...
				},
				{
					...
					Rules: []monitoringv1.Rule{
						...
						},
						{
							...
							Expr:   intstr.FromString("vector(28)"),
							Labels: map[string]string{
								"globalk1":      "globalv1",
								"slo01k1":       "slo01v1",
								"sloth_id":      "svc01-slo01",
						...
						},
						{
							...
							Expr:   intstr.FromString("slo:sli_error:ratio_rate4w{sloth_id=\"svc01-slo01\", sloth_service=\"svc01\", sloth_slo=\"slo01\"}\n/ on(sloth_id, sloth_slo, sloth_service) group_left\nslo:error_budget:ratio{sloth_id=\"svc01-slo01\", sloth_service=\"svc01\", sloth_slo=\"slo01\"}\n"),
							Labels: map[string]string{
								"globalk1":      "globalv1",
								"slo01k1":       "slo01v1",
								"sloth_id":      "svc01-slo01",
				...
				},
				{
					...
					Rules: []monitoringv1.Rule{
						...
						{
							Record: "slo:sli_error:ratio_rate4w",
							Expr:   intstr.FromString("sum(sum_over_time(slo:sli_error:ratio_rate5m{sloth_id=\"svc01-slo02\", sloth_service=\"svc01\", sloth_slo=\"slo02\"}[4w]))\n/ ignoring (sloth_window)\nsum(count_over_time(slo:sli_error:ratio_rate5m{sloth_id=\"svc01-slo02\", sloth_service=\"svc01\", sloth_slo=\"slo02\"}[4w]))\n"),
							Labels: map[string]string{
								"sloth_window": "4w",
							},
						},
				...
				},
				{
					...
					Rules: []monitoringv1.Rule{
						...
						{
							Record: "slo:period_burn_rate:ratio",
							Expr:   intstr.FromString("slo:sli_error:ratio_rate4w{sloth_id=\"svc01-slo02\", sloth_service=\"svc01\", sloth_slo=\"slo02\"}\n/ on(sloth_id, sloth_slo, sloth_service) group_left\nslo:error_budget:ratio{sloth_id=\"svc01-slo02\", sloth_service=\"svc01\", sloth_slo=\"slo02\"}\n"),
							Labels: map[string]string{
								"globalk1":      "globalv1",
								"sloth_id":      "svc01-slo02",
								"sloth_service": "svc01",
