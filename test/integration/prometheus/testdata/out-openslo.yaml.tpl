...
- name: sloth-slo-sli-recordings-svc01-slo1-0
  ...
  - record: slo:sli_error:ratio_rate30d
    expr: |
      sum(sum_over_time(slo:sli_error:ratio_rate5m{sloth_id="svc01-slo1-0", sloth_service="svc01", sloth_slo="slo1-0"}[30d]))
      / ignoring (sloth_window)
      sum(count_over_time(slo:sli_error:ratio_rate5m{sloth_id="svc01-slo1-0", sloth_service="svc01", sloth_slo="slo1-0"}[30d]))
    labels:
      sloth_window: 30d
