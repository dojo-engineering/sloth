...
- name: sloth-slo-sli-recordings-svc01-slo1
  ...
  - record: slo:sli_error:ratio_rate4w
    expr: |
      sum(sum_over_time(slo:sli_error:ratio_rate5m{sloth_id="svc01-slo1", sloth_service="svc01", sloth_slo="slo1"}[4w]))
      / ignoring (sloth_window)
      sum(count_over_time(slo:sli_error:ratio_rate5m{sloth_id="svc01-slo1", sloth_service="svc01", sloth_slo="slo1"}[4w]))
    labels:
      sloth_window: 4w
- name: sloth-slo-meta-recordings-svc01-slo1
  ...
  - record: slo:period_burn_rate:ratio
    expr: |
      slo:sli_error:ratio_rate4w{sloth_id="svc01-slo1", sloth_service="svc01", sloth_slo="slo1"}
      / on(sloth_id, sloth_slo, sloth_service) group_left
      slo:error_budget:ratio{sloth_id="svc01-slo1", sloth_service="svc01", sloth_slo="slo1"}
    labels:
      global01k1: global01v1
...
- name: sloth-slo-alerts-svc01-slo1
  ...
  - alert: myServiceAlert
    expr: |
      ...
      (
          (slo:sli_error:ratio_rate30m{sloth_id="svc01-slo1", sloth_service="svc01", sloth_slo="slo1"} > (5.6000000000000005 * 0.0009999999999999432))
          and ignoring (sloth_window)
          (slo:sli_error:ratio_rate6h{sloth_id="svc01-slo1", sloth_service="svc01", sloth_slo="slo1"} > (5.6000000000000005 * 0.0009999999999999432))
      )
    labels:
      alert01k1: alert01v1
      alert03k1: alert03v1
  ...
  - alert: myServiceAlert
    expr: |
      (
          (slo:sli_error:ratio_rate2h{sloth_id="svc01-slo1", sloth_service="svc01", sloth_slo="slo1"} > (2.8000000000000003 * 0.0009999999999999432))
          and ignoring (sloth_window)
          (slo:sli_error:ratio_rate1d{sloth_id="svc01-slo1", sloth_service="svc01", sloth_slo="slo1"} > (2.8000000000000003 * 0.0009999999999999432))
      )
      or ignoring (sloth_window)
      (
          (slo:sli_error:ratio_rate6h{sloth_id="svc01-slo1", sloth_service="svc01", sloth_slo="slo1"} > (0.9333333333333333 * 0.0009999999999999432))
          and ignoring (sloth_window)
          (slo:sli_error:ratio_rate3d{sloth_id="svc01-slo1", sloth_service="svc01", sloth_slo="slo1"} > (0.9333333333333333 * 0.0009999999999999432))
      )
    labels:
      alert01k1: alert01v1
      alert04k1: alert04v1
...
- name: sloth-slo-sli-recordings-svc01-slo02
  ...
  - record: slo:sli_error:ratio_rate4w
    expr: |
      sum(sum_over_time(slo:sli_error:ratio_rate5m{sloth_id="svc01-slo02", sloth_service="svc01", sloth_slo="slo02"}[4w]))
      / ignoring (sloth_window)
...
- name: sloth-slo-meta-recordings-svc01-slo02
  ...
  - record: slo:period_burn_rate:ratio
    expr: |
      slo:sli_error:ratio_rate4w{sloth_id="svc01-slo02", sloth_service="svc01", sloth_slo="slo02"}
      / on(sloth_id, sloth_slo, sloth_service) group_left
      slo:error_budget:ratio{sloth_id="svc01-slo02", sloth_service="svc01", sloth_slo="slo02"}
    labels:
      global01k1: global01v1
